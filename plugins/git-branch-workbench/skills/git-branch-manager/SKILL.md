...
5. The left panel groups local branches, worktrees, remote branches, and tags in that order. Groups can collapse independently. Selecting a local branch, remote branch, tag, or branch-backed worktree reads its history without changing the worktree.
